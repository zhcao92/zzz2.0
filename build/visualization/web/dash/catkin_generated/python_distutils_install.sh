...
echo_and_run cd "/home/qzl/Workspace/zzz2/src/visualization/web/dash"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/qzl/Workspace/zzz2/src/visualization/web/dash/setup.py" \
     \
    build --build-base "/home/qzl/Workspace/zzz2/build/visualization/web/dash" \
    install \
    --root="${DESTDIR-/}" \
