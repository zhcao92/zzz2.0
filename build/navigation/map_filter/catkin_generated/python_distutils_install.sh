...
echo_and_run cd "/home/qzl/Workspace/zzz2/src/navigation/map_filter"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/qzl/Workspace/zzz2/src/navigation/map_filter/setup.py" \
     \
    build --build-base "/home/qzl/Workspace/zzz2/build/navigation/map_filter" \
    install \
    --root="${DESTDIR-/}" \
