...
class ShougangMap(object):
    def __init__(self, offset_x=0, offset_y=0):
        ...
        self._next_road_id_list = [1, 2, 3, 0, 0, 6, 7, 8, 9, 10, 0]
    ...
    def load_lanes(self):
        ...
        road_0 = np.loadtxt(os.environ.get('ZZZ_ROOT') + '/zzz/src/navigation/my_data/my_lane2.txt',delimiter=',')
        road_1 = np.loadtxt(os.environ.get('ZZZ_ROOT') + '/zzz/src/navigation/my_data/my_lane3.txt',delimiter=',')
        road_2 = np.loadtxt(os.environ.get('ZZZ_ROOT') + '/zzz/src/navigation/my_data/my_lane4.txt',delimiter=',')
        road_3 = np.loadtxt(os.environ.get('ZZZ_ROOT') + '/zzz/src/navigation/my_data/my_lane1.txt',delimiter=',')
        road_4 = np.loadtxt(os.environ.get('ZZZ_ROOT') + '/zzz/src/navigation/my_data/zhulou.txt',delimiter=',')
        ...
        self._lanes.append(dense_polyline2d(road_3,1))
        self._lanes.append(dense_polyline2d(road_4,1))
