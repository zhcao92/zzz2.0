...
class ShougangMap(object):
    ...
    def load_lanes(self):
        ...
        road_0 = np.loadtxt(os.environ.get('ZZZ_ROOT') + '/zzz/src/navigation/map_provider/sumo/src/zzz_navigation_map_provider_sumo/sxjk.txt',delimiter=',')
    ...
    def ego_road(self):
        ...
        closest_lane = np.abs(dist_list[:, 0]).argsort()[:1][0]
