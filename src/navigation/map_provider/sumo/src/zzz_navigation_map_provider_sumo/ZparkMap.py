...
class ShougangMap(object):
    ...
    def load_lanes(self):
        ...
        road_0 = np.loadtxt(os.environ.get('ZZZ_ROOT') + '/zzz/src/navigation/data/zpark/0-0.txt',delimiter=',')
        road_1 = np.loadtxt(os.environ.get('ZZZ_ROOT') + '/zzz/src/navigation/data/zpark/1-0.txt',delimiter=',')
        road_2 = np.loadtxt(os.environ.get('ZZZ_ROOT') + '/zzz/src/navigation/data/zpark/2-0.txt',delimiter=',')
        
        self._lanes.append(dense_polyline2d(road_0,0.5))
        self._lanes.append(dense_polyline2d(road_1,0.5))
        self._lanes.append(dense_polyline2d(road_2,0.5))
    ...
    def ego_road(self):
        ...
        print("XY", self._ego_vehicle_x, self._ego_vehicle_y)
        print("++++++++++++++", dist_list)
