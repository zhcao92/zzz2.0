...
#define ROAD_CONTROL_ON true
#define ROAD_CONTROL_OFF false
...
namespace Control
{
  ...
  {
  private:
    //sub park instruction
    ros::Subscriber sub_park_start_,sub_park_over_;
    ...
    * @param msg 
    */
    void CallbackParkStart(const std_msgs::String &msg);
    ...
    * @param msg 
    */
    void CallbackParkOver(const std_msgs::Bool &msg);

    bool ChangeScenarioControl();
  public:
    xp_g3_ros_core(/* args */);
    ~xp_g3_ros_core();
    void control_run();
    ...
    //change scenario
    bool park_scenario_ = false;
    bool road_scenario_ = false;
