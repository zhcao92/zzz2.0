...
namespace Control
{
  ...
  private:
    ...
    bool RealtimeCommunicationDetection(const ssize_t trajectory_sqe_number);
  public:
    /* define funtion */
    /**
   * @name:
   ...
   * @return {type}
   */
    void get_trajectory(const vector<control_msgs::Trajectorypoint> &trajectory, const ssize_t trajectory_seq)
    {
      //
      trajectory_seq_ = trajectory_seq;
      //
