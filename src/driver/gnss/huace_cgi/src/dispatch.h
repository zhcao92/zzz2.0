/**
 * @file dispatch.h
 * @brief GNSS huace_cgi message struct
...
struct LongHeader {         // default long header
  ...
  uint16_t gps_week;       // GPS Week number.    //15,16
  uint32_t gps_millisecs;  // Milliseconds of week.
...
static bool validatePacket(const GpChc *packet) {
