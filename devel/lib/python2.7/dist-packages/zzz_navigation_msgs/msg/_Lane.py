...
class Lane(genpy.Message):
  _md5sum = "5cbd728e4b6ec4ecaad9c99fca2ccf56"
...
"""
  ...
  __slots__ = ['index','speed_limit','length','width','bidirectional','stop_state','central_path_points','central_path_coeffs','central_path_type','left_boundaries','right_boundaries','situations','traffic_light_pos']
  _slot_types = ['int16','float32','float32','float32','bool','uint8','zzz_navigation_msgs/LanePoint[]','float32[]','uint8','zzz_navigation_msgs/LaneBoundary[]','zzz_navigation_msgs/LaneBoundary[]','zzz_navigation_msgs/LaneSituation[]','float32[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       index,speed_limit,length,width,bidirectional,stop_state,central_path_points,central_path_coeffs,central_path_type,left_boundaries,right_boundaries,situations,traffic_light_pos
    ...
    if args or kwds:
      ...
      if self.situations is None:
        self.situations = []
      if self.traffic_light_pos is None:
        self.traffic_light_pos = []
    else:
      self.index = 0
      self.speed_limit = 0.
      self.length = 0.
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.central_path_coeffs))
      _x = self.central_path_type
      ...
      length = len(self.traffic_light_pos)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.traffic_light_pos))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.central_path_coeffs = s.unpack(str[start:end])
      start = end
      end += 1
      ...
      self.traffic_light_pos = s.unpack(str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(self.traffic_light_pos.tostring())
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.traffic_light_pos = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
