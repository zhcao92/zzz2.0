...
class DetectionBoxArray {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type DetectionBoxArray
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type DetectionBoxArray
    let len;
    let data = new DetectionBoxArray(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.detections[i] = DetectionBox.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static messageDefinition() {
    ...
    return `
    # Describe a list of 3D detections, for a multi-object 3D detector.
  ...
  static Resolve(msg) {
    ...
    const resolved = new DetectionBoxArray(null);
    ...
    if (msg.detections !== undefined) {
      ...
      for (let i = 0; i < resolved.detections.length; ++i) {
        resolved.detections[i] = DetectionBox.Resolve(msg.detections[i]);
      }
    }
    else {
      resolved.detections = []
...
module.exports = DetectionBoxArray;
