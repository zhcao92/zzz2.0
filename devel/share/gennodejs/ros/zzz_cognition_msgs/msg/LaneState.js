...
class LaneState {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.map_lane = null;
      this.ego_dis_to_lane_tail = null;
      this.ego_dis_to_lane_head = null;
      this.front_vehicles = null;
      this.rear_vehicles = null;
    }
    else {
      if (initObj.hasOwnProperty('map_lane')) {
        this.map_lane = initObj.map_lane
      }
      else {
        this.map_lane = new zzz_navigation_msgs.msg.Lane();
      }
      if (initObj.hasOwnProperty('ego_dis_to_lane_tail')) {
        this.ego_dis_to_lane_tail = initObj.ego_dis_to_lane_tail
      }
      else {
        this.ego_dis_to_lane_tail = 0.0;
      }
      if (initObj.hasOwnProperty('ego_dis_to_lane_head')) {
        this.ego_dis_to_lane_head = initObj.ego_dis_to_lane_head
      }
      else {
        this.ego_dis_to_lane_head = 0.0;
      }
      if (initObj.hasOwnProperty('front_vehicles')) {
        this.front_vehicles = initObj.front_vehicles
      }
      else {
        this.front_vehicles = [];
      }
      if (initObj.hasOwnProperty('rear_vehicles')) {
        this.rear_vehicles = initObj.rear_vehicles
      }
      else {
        this.rear_vehicles = [];
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type LaneState
    // Serialize message field [map_lane]
    bufferOffset = zzz_navigation_msgs.msg.Lane.serialize(obj.map_lane, buffer, bufferOffset);
    // Serialize message field [ego_dis_to_lane_tail]
    bufferOffset = _serializer.float32(obj.ego_dis_to_lane_tail, buffer, bufferOffset);
    // Serialize message field [ego_dis_to_lane_head]
    bufferOffset = _serializer.float32(obj.ego_dis_to_lane_head, buffer, bufferOffset);
    // Serialize message field [front_vehicles]
    // Serialize the length for message field [front_vehicles]
    bufferOffset = _serializer.uint32(obj.front_vehicles.length, buffer, bufferOffset);
    obj.front_vehicles.forEach((val) => {
      bufferOffset = RoadObstacle.serialize(val, buffer, bufferOffset);
    });
    // Serialize message field [rear_vehicles]
    // Serialize the length for message field [rear_vehicles]
    bufferOffset = _serializer.uint32(obj.rear_vehicles.length, buffer, bufferOffset);
    obj.rear_vehicles.forEach((val) => {
      bufferOffset = RoadObstacle.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type LaneState
    let len;
    let data = new LaneState(null);
    // Deserialize message field [map_lane]
    data.map_lane = zzz_navigation_msgs.msg.Lane.deserialize(buffer, bufferOffset);
    // Deserialize message field [ego_dis_to_lane_tail]
    data.ego_dis_to_lane_tail = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [ego_dis_to_lane_head]
    data.ego_dis_to_lane_head = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [front_vehicles]
    // Deserialize array length for message field [front_vehicles]
    len = _deserializer.uint32(buffer, bufferOffset);
    data.front_vehicles = new Array(len);
    for (let i = 0; i < len; ++i) {
      data.front_vehicles[i] = RoadObstacle.deserialize(buffer, bufferOffset)
    }
    // Deserialize message field [rear_vehicles]
    // Deserialize array length for message field [rear_vehicles]
    len = _deserializer.uint32(buffer, bufferOffset);
    data.rear_vehicles = new Array(len);
    for (let i = 0; i < len; ++i) {
      data.rear_vehicles[i] = RoadObstacle.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    let length = 0;
    length += zzz_navigation_msgs.msg.Lane.getMessageSize(object.map_lane);
    object.front_vehicles.forEach((val) => {
      length += RoadObstacle.getMessageSize(val);
    });
    object.rear_vehicles.forEach((val) => {
      length += RoadObstacle.getMessageSize(val);
    });
    return length + 16;
  }
  ...
  static datatype() {
    ...
    return 'zzz_cognition_msgs/LaneState';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'e0833b645b1384bbc1f57782616d73f5';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LaneState(null);
    if (msg.map_lane !== undefined) {
      resolved.map_lane = zzz_navigation_msgs.msg.Lane.Resolve(msg.map_lane)
    }
    else {
      resolved.map_lane = new zzz_navigation_msgs.msg.Lane()
    }

    if (msg.ego_dis_to_lane_tail !== undefined) {
      resolved.ego_dis_to_lane_tail = msg.ego_dis_to_lane_tail;
    }
    else {
      resolved.ego_dis_to_lane_tail = 0.0
    }

    if (msg.ego_dis_to_lane_head !== undefined) {
      resolved.ego_dis_to_lane_head = msg.ego_dis_to_lane_head;
    }
    else {
      resolved.ego_dis_to_lane_head = 0.0
    }

    if (msg.front_vehicles !== undefined) {
      resolved.front_vehicles = new Array(msg.front_vehicles.length);
      for (let i = 0; i < resolved.front_vehicles.length; ++i) {
        resolved.front_vehicles[i] = RoadObstacle.Resolve(msg.front_vehicles[i]);
      }
    }
    else {
      resolved.front_vehicles = []
    }

    if (msg.rear_vehicles !== undefined) {
      resolved.rear_vehicles = new Array(msg.rear_vehicles.length);
      for (let i = 0; i < resolved.rear_vehicles.length; ++i) {
        resolved.rear_vehicles[i] = RoadObstacle.Resolve(msg.rear_vehicles[i]);
      }
    }
    else {
      resolved.rear_vehicles = []
    }
