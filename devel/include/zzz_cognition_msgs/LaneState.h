// Generated by gencpp from file zzz_cognition_msgs/LaneState.msg
// DO NOT EDIT!


#ifndef ZZZ_COGNITION_MSGS_MESSAGE_LANESTATE_H
#define ZZZ_COGNITION_MSGS_MESSAGE_LANESTATE_H
...
struct LaneState_
{
  typedef LaneState_<ContainerAllocator> Type;

  LaneState_()
    : map_lane()
    , ego_dis_to_lane_tail(0.0)
    , ego_dis_to_lane_head(0.0)
    , front_vehicles()
    , rear_vehicles()  {
    }
  LaneState_(const ContainerAllocator& _alloc)
    : map_lane(_alloc)
    , ego_dis_to_lane_tail(0.0)
    , ego_dis_to_lane_head(0.0)
    , front_vehicles(_alloc)
    , rear_vehicles(_alloc)  {
  (void)_alloc;
    }



   typedef  ::zzz_navigation_msgs::Lane_<ContainerAllocator>  _map_lane_type;
  _map_lane_type map_lane;

   typedef float _ego_dis_to_lane_tail_type;
  _ego_dis_to_lane_tail_type ego_dis_to_lane_tail;

   typedef float _ego_dis_to_lane_head_type;
  _ego_dis_to_lane_head_type ego_dis_to_lane_head;

   typedef std::vector< ::zzz_cognition_msgs::RoadObstacle_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::zzz_cognition_msgs::RoadObstacle_<ContainerAllocator> >::other >  _front_vehicles_type;
  _front_vehicles_type front_vehicles;

   typedef std::vector< ::zzz_cognition_msgs::RoadObstacle_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::zzz_cognition_msgs::RoadObstacle_<ContainerAllocator> >::other >  _rear_vehicles_type;
  _rear_vehicles_type rear_vehicles;





  typedef boost::shared_ptr< ::zzz_cognition_msgs::LaneState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::zzz_cognition_msgs::LaneState_<ContainerAllocator> const> ConstPtr;

}; // struct LaneState_

typedef ::zzz_cognition_msgs::LaneState_<std::allocator<void> > LaneState;

typedef boost::shared_ptr< ::zzz_cognition_msgs::LaneState > LaneStatePtr;
typedef boost::shared_ptr< ::zzz_cognition_msgs::LaneState const> LaneStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::zzz_cognition_msgs::LaneState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::zzz_cognition_msgs::LaneState_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::zzz_cognition_msgs::LaneState_<ContainerAllocator1> & lhs, const ::zzz_cognition_msgs::LaneState_<ContainerAllocator2> & rhs)
{
  return lhs.map_lane == rhs.map_lane &&
    lhs.ego_dis_to_lane_tail == rhs.ego_dis_to_lane_tail &&
    lhs.ego_dis_to_lane_head == rhs.ego_dis_to_lane_head &&
    lhs.front_vehicles == rhs.front_vehicles &&
    lhs.rear_vehicles == rhs.rear_vehicles;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::zzz_cognition_msgs::LaneState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::zzz_cognition_msgs::LaneState_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::zzz_cognition_msgs::LaneState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::zzz_cognition_msgs::LaneState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::zzz_cognition_msgs::LaneState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::zzz_cognition_msgs::LaneState_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::zzz_cognition_msgs::LaneState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::zzz_cognition_msgs::LaneState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xe0833b645b1384bbULL;
  static const uint64_t static_value2 = 0xc1f57782616d73f5ULL;
};

template<class ContainerAllocator>
struct DataType< ::zzz_cognition_msgs::LaneState_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::zzz_cognition_msgs::LaneState_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# This message represent a state of lane in dynamic map\n"
"\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::zzz_cognition_msgs::LaneState_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      stream.next(m.map_lane);
      stream.next(m.ego_dis_to_lane_tail);
      stream.next(m.ego_dis_to_lane_head);
      stream.next(m.front_vehicles);
      stream.next(m.rear_vehicles);
    }
...
template<class ContainerAllocator>
struct Printer< ::zzz_cognition_msgs::LaneState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::zzz_cognition_msgs::LaneState_<ContainerAllocator>& v)
  {
    s << indent << "map_lane: ";
    s << std::endl;
    Printer< ::zzz_navigation_msgs::Lane_<ContainerAllocator> >::stream(s, indent + "  ", v.map_lane);
    s << indent << "ego_dis_to_lane_tail: ";
    Printer<float>::stream(s, indent + "  ", v.ego_dis_to_lane_tail);
    s << indent << "ego_dis_to_lane_head: ";
    Printer<float>::stream(s, indent + "  ", v.ego_dis_to_lane_head);
    s << indent << "front_vehicles[]" << std::endl;
    for (size_t i = 0; i < v.front_vehicles.size(); ++i)
    {
      s << indent << "  front_vehicles[" << i << "]: ";
      s << std::endl;
      s << indent;
      Printer< ::zzz_cognition_msgs::RoadObstacle_<ContainerAllocator> >::stream(s, indent + "    ", v.front_vehicles[i]);
    }
    s << indent << "rear_vehicles[]" << std::endl;
    for (size_t i = 0; i < v.rear_vehicles.size(); ++i)
    {
      s << indent << "  rear_vehicles[" << i << "]: ";
      s << std::endl;
      s << indent;
      Printer< ::zzz_cognition_msgs::RoadObstacle_<ContainerAllocator> >::stream(s, indent + "    ", v.rear_vehicles[i]);
    }
  }
};
...
#endif // ZZZ_COGNITION_MSGS_MESSAGE_LANESTATE_H
