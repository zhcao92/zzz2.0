// Generated by gencpp from file zzz_cognition_msgs/MapState.msg
// DO NOT EDIT!


#ifndef ZZZ_COGNITION_MSGS_MESSAGE_MAPSTATE_H
#define ZZZ_COGNITION_MSGS_MESSAGE_MAPSTATE_H
...
#include <zzz_cognition_msgs/JunctionMapState.h>
#include <zzz_cognition_msgs/MultiLaneMapState.h>
...
struct MapState_
{
  ...
  _ego_state_type ego_state;
   ...
   typedef  ::zzz_driver_msgs::FrenetSerretState2D_<ContainerAllocator>  _ego_ffstate_type;
  _ego_ffstate_type ego_ffstate;

   typedef uint8_t _model_type;
  _model_type model;

   typedef  ::zzz_cognition_msgs::JunctionMapState_<ContainerAllocator>  _jmap_type;
  _jmap_type jmap;

   typedef  ::zzz_cognition_msgs::MultiLaneMapState_<ContainerAllocator>  _mmap_type;
  _mmap_type mmap;



// reducing the odds to have name collisions with Windows.h 
#if defined(_WIN32) && defined(MODEL_JUNCTION_MAP)
  #undef MODEL_JUNCTION_MAP
#endif
#if defined(_WIN32) && defined(MODEL_MULTILANE_MAP)
  #undef MODEL_MULTILANE_MAP
#endif

  enum {
    MODEL_JUNCTION_MAP = 0u,
    MODEL_MULTILANE_MAP = 1u,
  };


  typedef boost::shared_ptr< ::zzz_cognition_msgs::MapState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::zzz_cognition_msgs::MapState_<ContainerAllocator> const> ConstPtr;

}; // struct MapState_

typedef ::zzz_cognition_msgs::MapState_<std::allocator<void> > MapState;

typedef boost::shared_ptr< ::zzz_cognition_msgs::MapState > MapStatePtr;
typedef boost::shared_ptr< ::zzz_cognition_msgs::MapState const> MapStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::zzz_cognition_msgs::MapState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::zzz_cognition_msgs::MapState_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::zzz_cognition_msgs::MapState_<ContainerAllocator1> & lhs, const ::zzz_cognition_msgs::MapState_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.ego_state == rhs.ego_state &&
    lhs.ego_ffstate == rhs.ego_ffstate &&
    lhs.model == rhs.model &&
    lhs.jmap == rhs.jmap &&
    lhs.mmap == rhs.mmap;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::zzz_cognition_msgs::MapState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::zzz_cognition_msgs::MapState_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::zzz_cognition_msgs::MapState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::zzz_cognition_msgs::MapState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::zzz_cognition_msgs::MapState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::zzz_cognition_msgs::MapState_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::zzz_cognition_msgs::MapState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::zzz_cognition_msgs::MapState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xb09539f96f45b795ULL;
  static const uint64_t static_value2 = 0x144626c4a7e1690aULL;
};

template<class ContainerAllocator>
struct DataType< ::zzz_cognition_msgs::MapState_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::zzz_cognition_msgs::MapState_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# This message represents a decision_oriented specific representation of dynamic map\n"
"\n"
"Header header\n"
"\n"
"# Ego Vehicle Info\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::zzz_cognition_msgs::MapState_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      stream.next(m.header);
      stream.next(m.ego_state);
      stream.next(m.ego_ffstate);
      stream.next(m.model);
      stream.next(m.jmap);
      stream.next(m.mmap);
    }
...
template<class ContainerAllocator>
struct Printer< ::zzz_cognition_msgs::MapState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::zzz_cognition_msgs::MapState_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << indent << "ego_ffstate: ";
    s << std::endl;
    Printer< ::zzz_driver_msgs::FrenetSerretState2D_<ContainerAllocator> >::stream(s, indent + "  ", v.ego_ffstate);
    s << indent << "model: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.model);
    s << indent << "jmap: ";
    s << std::endl;
    Printer< ::zzz_cognition_msgs::JunctionMapState_<ContainerAllocator> >::stream(s, indent + "  ", v.jmap);
    s << indent << "mmap: ";
    s << std::endl;
    Printer< ::zzz_cognition_msgs::MultiLaneMapState_<ContainerAllocator> >::stream(s, indent + "  ", v.mmap);
  }
};
...
#endif // ZZZ_COGNITION_MSGS_MESSAGE_MAPSTATE_H
