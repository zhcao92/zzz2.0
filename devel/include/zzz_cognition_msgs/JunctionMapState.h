// Generated by gencpp from file zzz_cognition_msgs/JunctionMapState.msg
// DO NOT EDIT!


#ifndef ZZZ_COGNITION_MSGS_MESSAGE_JUNCTIONMAPSTATE_H
#define ZZZ_COGNITION_MSGS_MESSAGE_JUNCTIONMAPSTATE_H
...
struct JunctionMapState_
{
  typedef JunctionMapState_<ContainerAllocator> Type;

  JunctionMapState_()
    : reference_path()
    , drivable_area()
    , obstacles()
    , distance_to_lanes(0.0)  {
    }
  JunctionMapState_(const ContainerAllocator& _alloc)
  ...
  (void)_alloc;
   ...
   typedef  ::zzz_cognition_msgs::LaneState_<ContainerAllocator>  _reference_path_type;
  ...
  _obstacles_type obstacles;
   ...
   typedef float _distance_to_lanes_type;
  _distance_to_lanes_type distance_to_lanes;





  typedef boost::shared_ptr< ::zzz_cognition_msgs::JunctionMapState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::zzz_cognition_msgs::JunctionMapState_<ContainerAllocator> const> ConstPtr;

}; // struct JunctionMapState_

typedef ::zzz_cognition_msgs::JunctionMapState_<std::allocator<void> > JunctionMapState;

typedef boost::shared_ptr< ::zzz_cognition_msgs::JunctionMapState > JunctionMapStatePtr;
typedef boost::shared_ptr< ::zzz_cognition_msgs::JunctionMapState const> JunctionMapStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::zzz_cognition_msgs::JunctionMapState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::zzz_cognition_msgs::JunctionMapState_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::zzz_cognition_msgs::JunctionMapState_<ContainerAllocator1> & lhs, const ::zzz_cognition_msgs::JunctionMapState_<ContainerAllocator2> & rhs)
{
  return lhs.reference_path == rhs.reference_path &&
    lhs.drivable_area == rhs.drivable_area &&
    lhs.obstacles == rhs.obstacles &&
    lhs.distance_to_lanes == rhs.distance_to_lanes;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::zzz_cognition_msgs::JunctionMapState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::zzz_cognition_msgs::JunctionMapState_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::zzz_cognition_msgs::JunctionMapState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::zzz_cognition_msgs::JunctionMapState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::zzz_cognition_msgs::JunctionMapState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::zzz_cognition_msgs::JunctionMapState_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::zzz_cognition_msgs::JunctionMapState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::zzz_cognition_msgs::JunctionMapState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xba2d16e33b435f07ULL;
  static const uint64_t static_value2 = 0xf3b1aab80a4c95c9ULL;
};

template<class ContainerAllocator>
struct DataType< ::zzz_cognition_msgs::JunctionMapState_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::zzz_cognition_msgs::JunctionMapState_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# This message describe a free-space driving model\n"
"\n"
"# -------- Reference Path info ----------\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::zzz_cognition_msgs::JunctionMapState_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.distance_to_lanes);
    }
...
template<class ContainerAllocator>
struct Printer< ::zzz_cognition_msgs::JunctionMapState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::zzz_cognition_msgs::JunctionMapState_<ContainerAllocator>& v)
  {
    s << indent << "reference_path: ";
    s << std::endl;
    Printer< ::zzz_cognition_msgs::LaneState_<ContainerAllocator> >::stream(s, indent + "  ", v.reference_path);
    ...
    s << indent << "distance_to_lanes: ";
    Printer<float>::stream(s, indent + "  ", v.distance_to_lanes);
  }
};
...
#endif // ZZZ_COGNITION_MSGS_MESSAGE_JUNCTIONMAPSTATE_H
