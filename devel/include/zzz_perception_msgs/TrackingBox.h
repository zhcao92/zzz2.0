// Generated by gencpp from file zzz_perception_msgs/TrackingBox.msg
// DO NOT EDIT!


#ifndef ZZZ_PERCEPTION_MSGS_MESSAGE_TRACKINGBOX_H
#define ZZZ_PERCEPTION_MSGS_MESSAGE_TRACKINGBOX_H
...
struct TrackingBox_
{
  typedef TrackingBox_<ContainerAllocator> Type;
  ...
  TrackingBox_(const ContainerAllocator& _alloc)
    : uid(0)
    , confidence(0.0)
    , classes(_alloc)
    , signal(_alloc)
  ...
  typedef boost::shared_ptr< ::zzz_perception_msgs::TrackingBox_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::zzz_perception_msgs::TrackingBox_<ContainerAllocator> const> ConstPtr;

}; // struct TrackingBox_

typedef ::zzz_perception_msgs::TrackingBox_<std::allocator<void> > TrackingBox;

typedef boost::shared_ptr< ::zzz_perception_msgs::TrackingBox > TrackingBoxPtr;
typedef boost::shared_ptr< ::zzz_perception_msgs::TrackingBox const> TrackingBoxConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::zzz_perception_msgs::TrackingBox_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::zzz_perception_msgs::TrackingBox_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::zzz_perception_msgs::TrackingBox_<ContainerAllocator1> & lhs, const ::zzz_perception_msgs::TrackingBox_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::zzz_perception_msgs::TrackingBox_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::zzz_perception_msgs::TrackingBox_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::zzz_perception_msgs::TrackingBox_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::zzz_perception_msgs::TrackingBox_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::zzz_perception_msgs::TrackingBox_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::zzz_perception_msgs::TrackingBox_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::zzz_perception_msgs::TrackingBox_<ContainerAllocator> >
{
  ...
  static const char* value(const ::zzz_perception_msgs::TrackingBox_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x8a670f6260df74e0ULL;
  static const uint64_t static_value2 = 0x9e45192f57a95a73ULL;
};

template<class ContainerAllocator>
struct DataType< ::zzz_perception_msgs::TrackingBox_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::zzz_perception_msgs::TrackingBox_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# Defines a box-shaped 3D tracking result.\n"
"\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::zzz_perception_msgs::TrackingBox_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::zzz_perception_msgs::TrackingBox_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::zzz_perception_msgs::TrackingBox_<ContainerAllocator>& v)
  {
    s << indent << "uid: ";
...
#endif // ZZZ_PERCEPTION_MSGS_MESSAGE_TRACKINGBOX_H
